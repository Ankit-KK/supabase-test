...
serve(async (req) => {
  ...
  try {
    ...
    const allowedSettings = ['moderation_mode', 'telegram_moderation_enabled', 'discord_moderation_enabled', 'tts_enabled', 'hyperemotes_enabled', 'hyperemotes_min_amount', 'alert_box_scale', 'goal_is_active', 'goal_name', 'goal_target_amount', 'media_upload_enabled', 'media_moderation_enabled', 'media_min_amount', 'tts_language_boost'];
