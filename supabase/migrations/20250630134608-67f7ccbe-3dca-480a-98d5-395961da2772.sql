...
-- Update the create_obs_token function to work without email verification for now
...
DECLARE
  new_token text;
BEGIN
  -- For now, skip the email verification since we're using session-based auth
