-- Complete Database Function Cleanup and Recreation
-- Phase 1: Drop ALL existing functions (111 total)

-- Drop all existing functions systematically
