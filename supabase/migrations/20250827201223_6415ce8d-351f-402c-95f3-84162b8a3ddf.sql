...
CREATE POLICY "Anyone can create ankit donations" 
ON public.ankit_donations 
FOR INSERT 
WITH CHECK (true);

CREATE POLICY "Anyone can update ankit donations" 
ON public.ankit_donations 
FOR UPDATE 
USING (true);

CREATE POLICY "Anyone can view ankit donations" 
ON public.ankit_donations 
FOR SELECT 
USING (true);

CREATE POLICY "Streamers can manage their ankit donations" 
ON public.ankit_donations 
FOR ALL 
