-- Fix ambiguous column reference in add_streamer_moderator function
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE s.id = p_streamer_id AND s.user_id = current_user_id
  ) THEN
...
-- Fix ambiguous column reference in remove_streamer_moderator function
