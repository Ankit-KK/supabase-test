  ...
  public: {
    Tables: {
      ...
      brigzard_donations: {
        ...
        Relationships: [
          {
            foreignKeyName: "brigzard_donations_streamer_id_fkey"
            columns: ["streamer_id"]
            isOneToOne: false
            referencedRelation: "streamers"
            referencedColumns: ["id"]
      ...
      demigod_donations: {
        ...
        Relationships: [
          {
            foreignKeyName: "demigod_donations_streamer_id_fkey"
            columns: ["streamer_id"]
            isOneToOne: false
            referencedRelation: "streamers"
            referencedColumns: ["id"]
      ...
      dorp_plays_donations: {
        ...
        Relationships: [
          {
            foreignKeyName: "dorp_plays_donations_streamer_id_fkey"
            columns: ["streamer_id"]
            isOneToOne: false
            referencedRelation: "streamers"
            referencedColumns: ["id"]
      ...
      mr_champion_donations: {
        ...
        Relationships: [
          {
            foreignKeyName: "mr_champion_donations_streamer_id_fkey"
            columns: ["streamer_id"]
            isOneToOne: false
            referencedRelation: "streamers"
            referencedColumns: ["id"]
      ...
      streamers: {
        Row: {
          ...
          tts_language_boost: string | null
      ...
      w_era_donations: {
        ...
        Relationships: [
          {
            foreignKeyName: "w_era_donations_streamer_id_fkey"
            columns: ["streamer_id"]
            isOneToOne: false
            referencedRelation: "streamers"
            referencedColumns: ["id"]
      ...
      zishu_donations: {
        ...
        Relationships: [
          {
            foreignKeyName: "zishu_donations_streamer_id_fkey"
            columns: ["streamer_id"]
            isOneToOne: false
            referencedRelation: "streamers"
            referencedColumns: ["id"]
