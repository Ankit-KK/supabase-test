        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <img src={hyperchatLogo} alt="HyperChat" className="h-8" />
          ...
          <div>
            <h3 className="font-medium mb-4 text-foreground">For Creators</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#features" className="hover:text-primary transition-colors">About HyperChat</a></li>
              <li><a href="#services" className="hover:text-primary transition-colors">Community Building</a></li>
              <li><Link to="/contact" className="hover:text-primary transition-colors">Creator Resources</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#features" className="hover:text-primary transition-colors">Audience Expression</a></li>
              <li><a href="#features" className="hover:text-primary transition-colors">Shared Experiences</a></li>
              <li><a href="#features" className="hover:text-primary transition-colors">Community Atmosphere</a></li>
              <li><a href="#features" className="hover:text-primary transition-colors">Creator Connection</a></li>
            </ul>
          </div>
          <div>
            <h3 className="font-medium mb-4 text-foreground">Company</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/about" className="hover:text-primary transition-colors">About HyperChat</Link></li>
              ...
              <li><Link to="/cancellation-refunds" className="hover:text-primary transition-colors">Cancellation & Refunds</Link></li>
              <li><Link to="/shipping" className="hover:text-primary transition-colors">Support</Link></li>
            </ul>
          </div>
        </div>
