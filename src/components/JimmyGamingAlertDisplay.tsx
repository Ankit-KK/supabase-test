...
interface JimmyGamingAlertDisplayProps {
  donation: Donation | null;
  isVisible: boolean;
  scale?: number;
}

export const JimmyGamingAlertDisplay: React.FC<JimmyGamingAlertDisplayProps> = ({
  donation,
  isVisible,
  scale = 1.0
}) => {
...
export default JimmyGamingAlertDisplay;
