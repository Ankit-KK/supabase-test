...
interface ChiaaGamingAlertDisplayProps {
  donation: Donation | null;
  isVisible: boolean;
  scale?: number;
}

export const ChiaaGamingAlertDisplay: React.FC<ChiaaGamingAlertDisplayProps> = ({
  donation,
  isVisible,
  scale = 1.0
}) => {
  ...
  return (
    <div className="fixed inset-0 flex items-end justify-center pb-[10%] pointer-events-none">
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(236, 72, 153, 0.95) 0%, rgba(190, 24, 93, 0.95) 100%)',
