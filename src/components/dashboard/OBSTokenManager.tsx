              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Input
                        value={`https://vsevsjvtrshgeiudrnth.supabase.com/functions/v1/get-current-audio?token=${activeToken.token}`}
                        readOnly
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => copyToClipboard(
                          `https://vsevsjvtrshgeiudrnth.supabase.com/functions/v1/get-current-audio?token=${activeToken.token}`,
