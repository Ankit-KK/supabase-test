...
const Streamer32 = () => {
  ...
  useEffect(() => {
    ...
    const fetchStreamerSettings = async () => {
      const { data } = await supabase.rpc('get_streamer_public_settings', { slug: 'streamer32' });
      if (data?.[0]) {
  ...
  const handlePaymentWithPhone = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('create-payment-order-streamer32', {
        body: {
          name: formData.name,
      ...
      const checkoutOptions = {
        ...
        returnUrl: `${window.location.origin}/streamer32`,
      };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 p-4">
      <div className="container mx-auto max-w-2xl py-8">
        <Card className="border-teal-200 dark:border-teal-800 shadow-xl">
          <CardHeader className="text-center space-y-2 bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-gray-800 dark:to-gray-900">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  maxLength={50}
                  className="h-12 text-lg border-2 focus:border-teal-500"
              ...
              <div className="space-y-2">
                ...
                />
                {isHyperemote && (
                  <div className="flex items-center gap-2 p-3 bg-gradient-to-r from-teal-100 to-cyan-100 dark:from-teal-900/20 dark:to-cyan-900/20 rounded-lg border-2 border-teal-300 dark:border-teal-700">
              ...
              {donationType === 'message' && (
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    rows={4}
                    className="text-base border-2 focus:border-teal-500 resize-none"
