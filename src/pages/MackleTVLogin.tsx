...
const MackleTVLogin = () => {
  const [username, setUsername] = useState("mackletv");
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          ...
          description: "Welcome to the MackleTV Dashboard!",
        });
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-background">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-2xl">MackleTV Dashboard Login</CardTitle>
          <CardDescription>
