      ...
      <div className="container px-4 md:px-6 py-32 mx-auto max-w-4xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p>
            ...
            agreement by and between STREAMHEART PRIVATE LIMITED, ("Website Owner" or "we" or "us" or "our") and you
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            ...
            <li>
              ...
              websites. We are not responsible for the content, privacy practices, or functionality of such
              third party websites.
            </li>
            <li>
              We are not liable for any consequences that may arise from technical issues or operational
              interruptions experienced during the use of our website or Services.
            </li>
            <li>
            ...
            <li>
              ...
              jurisdiction of the courts in Vasundhara, Uttar Pradesh.
            </li>
            <li>
