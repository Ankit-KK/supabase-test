...
const MackleDashboard = () => {
  ...
  useEffect(() => {
    const channel = supabase
      .channel('mackle-dashboard-donations')
      .on(
        'postgres_changes',
        { 
          event: 'INSERT', 
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">Mackle Dashboard</h1>
...
export default MackleDashboard;
