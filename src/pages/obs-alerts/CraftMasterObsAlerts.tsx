...
const CraftMasterObsAlerts = () => {
  const { config: pusherConfig, loading: configLoading } = usePusherConfig('craftmaster');
  ...
  const {
    ...
    channelName: 'craftmaster-alerts',
    ...
    <div className="fixed inset-0 bg-transparent">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed bottom-4 left-4 bg-black/80 text-white p-3 rounded-lg text-xs space-y-2 max-w-xs">
          ...
          <div>Channel: craftmaster-alerts</div>
...
export default CraftMasterObsAlerts;
