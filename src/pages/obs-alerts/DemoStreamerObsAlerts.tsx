...
const DemoStreamerObsAlerts = () => {
  const { config: pusherConfig, loading: configLoading } = usePusherConfig('demostreamer');
  ...
  const {
    ...
    channelName: 'demostreamer-alerts',
    ...
    <div className="fixed inset-0 bg-transparent">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed bottom-4 left-4 bg-black/80 text-white p-2 rounded text-xs space-y-1">
          ...
          <div>Channel: demostreamer-alerts</div>
...
export default DemoStreamerObsAlerts;
