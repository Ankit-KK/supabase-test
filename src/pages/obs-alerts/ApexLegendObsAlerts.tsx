...
const ApexLegendObsAlerts = () => {
  const { config: pusherConfig, loading: configLoading } = usePusherConfig('apexlegend');
    ...
    <div className="fixed inset-0 bg-transparent">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed bottom-4 left-4 bg-black/80 text-white p-3 rounded-lg text-xs space-y-2 max-w-xs">
          ...
          <div>Channel: apexlegend-alerts</div>
...
export default ApexLegendObsAlerts;
