...
const CodeLiveObsAlerts = () => {
  const { config: pusherConfig, loading: configLoading } = usePusherConfig('codelive');
    ...
    <div className="min-h-screen bg-transparent relative overflow-hidden">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed bottom-4 left-4 bg-black/80 text-white p-2 rounded text-xs space-y-1">
          ...
          <div>Channel: codelive-alerts</div>
...
export default CodeLiveObsAlerts;
