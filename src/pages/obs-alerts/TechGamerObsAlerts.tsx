...
const TechGamerObsAlerts = () => {
  const { config: pusherConfig, loading: configLoading } = usePusherConfig('techgamer');
    ...
    <div className="min-h-screen bg-transparent relative overflow-hidden">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed bottom-4 left-4 bg-black/80 text-white p-2 rounded text-xs space-y-1">
          ...
          <div>Channel: techgamer-alerts</div>
...
export default TechGamerObsAlerts;
