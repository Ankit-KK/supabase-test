...
const Streamer33 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-fuchsia-50 via-pink-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
        ...
        <Card className="border-fuchsia-200 dark:border-fuchsia-800 shadow-xl">
          <CardHeader className="text-center space-y-2 pb-6">
            <div className="flex items-center justify-center mb-2">
              <Star className="w-10 h-10" style={{ color: brandColor }} />
            </div>
            <CardTitle className="text-3xl font-bold bg-gradient-to-r from-fuchsia-600 to-pink-600 bg-clip-text text-transparent">
              Support Streamer 33
            </CardTitle>
