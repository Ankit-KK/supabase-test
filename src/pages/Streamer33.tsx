...
const Streamer33 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-fuchsia-50 via-pink-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 p-4">
      <div className="container mx-auto max-w-2xl py-8">
        <Card className="border-fuchsia-200 dark:border-fuchsia-800 shadow-xl">
          <CardHeader className="text-center space-y-2 bg-gradient-to-r from-fuchsia-50 to-pink-50 dark:from-gray-800 dark:to-gray-900">
            <div className="flex items-center justify-center gap-2 mb-2">
              <Star className="w-8 h-8" style={{ color: brandColor }} />
            </div>
            <CardTitle className="text-4xl font-bold bg-gradient-to-r from-fuchsia-600 to-pink-600 bg-clip-text text-transparent">
              Support Streamer 33
            </CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  maxLength={50}
                  className="h-12 text-lg border-2 focus:border-fuchsia-500"
              ...
              <div className="space-y-2">
                ...
                />
                {isHyperemote && (
                  <div className="flex items-center gap-2 p-3 bg-gradient-to-r from-fuchsia-100 to-pink-100 dark:from-fuchsia-900/20 dark:to-pink-900/20 rounded-lg border-2 border-fuchsia-300 dark:border-fuchsia-700">
              ...
              {donationType === 'message' && (
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    rows={4}
                    className="text-base border-2 focus:border-fuchsia-500 resize-none"
