          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-12">
            ...
            <Card className="bg-black/40 border-cyan-400/30 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  Access enhanced features and dashboard
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <Button 
                  className="w-full bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600"
                  onClick={() => window.open('/cyber-striker/payment', '_blank')}
                >
                  <Zap className="mr-2 h-4 w-4" />
                  Quick Donation Portal
                </Button>
                <Button 
                  variant="outline" 
                  className="w-full border-cyan-400/50 text-cyan-400 hover:bg-cyan-400/10"
                  onClick={() => window.open('/cyber-striker/dashboard', '_blank')}
                >
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-cyan-400/50 text-cyan-400 hover:bg-cyan-400/10"
                  onClick={() => window.open('/cyber-striker/settings', '_blank')}
                >
