...
const Streamer28 = () => {
  ...
  useEffect(() => {
    ...
    const fetchStreamerSettings = async () => {
      const { data } = await supabase.rpc('get_streamer_public_settings', { slug: 'streamer28' });
      if (data?.[0]) {
  ...
  const handlePaymentWithPhone = async () => {
    ...
    try {
      ...
      const checkoutOptions = {
        ...
        returnUrl: `${window.location.origin}/streamer28`,
      };
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 via-purple-600/20 to-purple-400/20 opacity-50 blur-xl"></div>
          <CardHeader className="text-center relative z-10">
            ...
            <p className="text-muted-foreground text-sm">
              Support Streamer 28 with your donation
            </p>
          </CardHeader>
