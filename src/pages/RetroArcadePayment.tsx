...
const RetroArcadePayment = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-900 via-yellow-900 to-green-900 p-6">
      <div className="container mx-auto max-w-md py-10">
        <Card>
          <CardHeader>
            <CardTitle>Support Retro Arcade</CardTitle>
            <CardDescription>
...
export default RetroArcadePayment;
