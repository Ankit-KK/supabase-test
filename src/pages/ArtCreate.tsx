...
import { Palette, Zap, Heart, Gift } from 'lucide-react';
...
const ArtCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('create-payment-order-artcreate', {
        body: {
          name: name.trim(),
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-white">ArtCreate</h1>
          </div>
          <p className="text-pink-200 text-lg">Support amazing art creation and live drawing sessions!</p>
          <Badge variant="secondary" className="mt-2 bg-pink-500/20 text-pink-300 border-pink-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="bg-slate-800/50 border-pink-500/20 backdrop-blur">
              <CardHeader>
                ...
                <CardDescription className="text-pink-200">
                  Your support helps create beautiful art and inspiring creative content!
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-slate-700/50 border-pink-500/30 text-white placeholder:text-slate-400"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="bg-slate-700/50 border-pink-500/30 text-white placeholder:text-slate-400 min-h-[100px]"
                      maxLength={500}
                    />
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-pink-600 to-pink-500 hover:from-pink-700 hover:to-pink-600 text-white font-semibold py-3"
                  >
                ...
                <div className="space-y-3">
                  {recentDonations.length > 0 ? (
                    recentDonations.map((donation, index) => (
                      <div key={index} className="bg-slate-700/30 rounded-lg p-3 border border-pink-500/10">
                    ...
                    <p className="text-slate-400 text-center py-4">
                      Be the first to support ArtCreate!
                    </p>
                  )}
                </div>
              </CardContent>
