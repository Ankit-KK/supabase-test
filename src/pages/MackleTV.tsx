  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const donationData = {
        ...
        message,
        orderId,
        donationType: "mackletv", // Add donation type to differentiate
      };
  ...
  return (
    <div className="container mx-auto max-w-md py-10">
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Make a Donation to MackleTV</h1>
          <p className="text-muted-foreground mt-2">
            Support MackleTV's work by making a donation
          </p>
        </div>
