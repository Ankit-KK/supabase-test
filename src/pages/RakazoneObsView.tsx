...
const RakazoneObsView = () => {
  ...
  useEffect(() => {
    ...
    const channelName = `rakazone-obs-donations-${id || 'messages'}`;
  ...
  return (
    <div className="h-screen w-screen flex items-start justify-start bg-transparent overflow-hidden">
      <div 
        className="max-w-xl animate-fade-in bg-black/60 backdrop-blur-md rounded-2xl px-6 py-4 shadow-xl m-4 border border-red-500/30"
        style={{ width: "auto", maxWidth: "90vw" }} // Dynamic width based on content
      >
        <div className="flex items-center gap-2 mb-2">
          <span className="font-bold text-xl text-red-400">{activeDonation.name}</span>
...
export default RakazoneObsView;
