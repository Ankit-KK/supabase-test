...
const VIPBhaiAudioPlayer = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-950 via-yellow-900 to-amber-800 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl space-y-6">
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white">VIP BHAI Voice Messages</h1>
            {queueSize > 0 && (
              <div className="text-amber-300 mt-2">{queueSize} message(s) in queue</div>
            )}
          </div>
        </div>
...
export default VIPBhaiAudioPlayer;
