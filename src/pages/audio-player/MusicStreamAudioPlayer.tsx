...
import { Music, SkipBack, SkipForward, RefreshCw } from 'lucide-react';
import { AudioPlayer } from '@/components/AudioPlayer';
import { useAudioPlayer } from '@/hooks/useAudioPlayer';

const MusicStreamAudioPlayer = () => {
  const {
    donations,
    currentDonation,
    currentIndex,
    ...
    goToIndex,
    refresh
  } = useAudioPlayer({ tableName: 'musicstream_donations' });

  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-950 via-slate-900 to-purple-800">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-white">MusicStream Voice Messages</h1>
          </div>
        ...
        {/* Queue */}
        {totalDonations > 1 && (
          <Card className="max-w-4xl mx-auto bg-slate-800/50 border-purple-500/20 backdrop-blur">
            <CardHeader>
                ...
                {donations.map((donation, index) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <span className="text-purple-300 font-medium">{donation.name}</span>
...
export default MusicStreamAudioPlayer;