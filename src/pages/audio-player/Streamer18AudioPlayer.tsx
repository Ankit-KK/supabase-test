...
const Streamer18AudioPlayer = () => {
  const {
    ...
    tableName: 'streamer18_donations' as any
  });
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-md mx-auto space-y-4">
        <div className="text-center space-y-2">
          <h1 className="text-2xl font-bold text-primary">Streamer 18 Audio Player</h1>
        ...
        <AudioPlayer
          ...
          tableName="streamer18_donations"
        />
      </div>
    </div>
  );
...
export default Streamer18AudioPlayer;
