...
const Demo4Dashboard = () => {
    ...
    const checkAccess = async () => {
      ...
      try {
        ...
        const hasDemoAccess = data?.some((streamer: any) => 
          streamer.streamer_slug === 'demo4' || streamer.is_admin === true
        );
        if (hasDemoAccess) {
          setHasAccess(true);
        } else {
  ...
  return <StreamerDashboard streamerSlug="demo4" streamerName="Demo Streamer 4" brandColor="#f43f5e" tableName="demo4_donations" />;
};
