...
const Streamer35 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-fuchsia-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
        ...
        <Card className="border-purple-200 dark:border-purple-800 shadow-xl">
          <CardHeader className="text-center space-y-2 pb-6">
            <div className="flex items-center justify-center mb-2">
              <Crown className="w-10 h-10" style={{ color: brandColor }} />
            </div>
