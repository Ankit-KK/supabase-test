...
const Streamer36 = () => {
  ...
  useEffect(() => {
    ...
    const fetchStreamerSettings = async () => {
      const { data } = await supabase.rpc('get_streamer_public_settings', { slug: 'streamer36' });
      if (data?.[0]) {
  ...
  const handlePaymentWithPhone = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('create-payment-order-streamer36', {
        body: {
          name: formData.name,
      ...
      const checkoutOptions = {
        ...
        returnUrl: `${window.location.origin}/streamer36`,
      };
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-red-50 dark:from-gray-900 dark:to-gray-800 p-4">
      <div className="container mx-auto max-w-2xl py-8">
        <Card className="border-rose-200 dark:border-rose-800 shadow-xl">
          <CardHeader className="text-center space-y-2 bg-gradient-to-r from-rose-50 to-pink-50 dark:from-gray-800 dark:to-gray-900">
            <div className="flex items-center justify-center gap-2 mb-2">
              <Heart className="w-8 h-8" style={{ color: brandColor }} />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  maxLength={50}
                  className="h-12 text-lg border-2 focus:border-rose-500"
              ...
              <div className="space-y-2">
                ...
                />
                {isHyperemote && (
                  <div className="flex items-center gap-2 p-3 bg-gradient-to-r from-rose-100 to-pink-100 dark:from-rose-900/20 dark:to-pink-900/20 rounded-lg border-2 border-rose-300 dark:border-rose-700">
