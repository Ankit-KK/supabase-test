  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      for (let i = ps.length - 1; i >= 0; i--) {
        ...
        g.addColorStop(0, `rgba(30,50,90,${p.alpha})`);
              ...
              <div className="nv-body">
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                      ...
                      <span
                        style={{
                          fontSize: 11,
                          fontWeight: 700,
                          color: "var(--nv-scarlet-lt)",
                          textShadow: "0 0 8px var(--nv-scarlet-lt)",
                          fontFamily: "Orbitron,monospace",
                          letterSpacing: "0.1em",
                        }}
                      >
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                      ...
                      <span
                        style={{
                          fontSize: 11,
                          fontWeight: 700,
                          color: "var(--nv-steel-lt)",
                          textShadow: "0 0 8px var(--nv-steel-lt)",
                          fontFamily: "Orbitron,monospace",
                          letterSpacing: "0.1em",
                        }}
                      >
                ...
                <a
                  ...
                  style={{
                    ...
                    fontSize: 9,
                    fontFamily: "'ModernWarfare', Arial, sans-serif",
