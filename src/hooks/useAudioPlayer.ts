...
type TableName = 'ankit_donations' | 'chiaa_gaming_donations' | 'looteriya_gaming_donations' | 'sizzors_donations' | 'damask_plays_donations' | 'neko_xenpai_donations' | 'thunderx_donations';
