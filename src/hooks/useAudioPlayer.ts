...
type TableName = 'ankit_donations' | 'chiaa_gaming_donations' | 'demostreamer_donations' | 'techgamer_donations' | 'musicstream_donations' | 'fitnessflow_donations' | 'artcreate_donations' | 'codelive_donations';
